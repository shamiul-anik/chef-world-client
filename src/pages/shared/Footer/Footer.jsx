...
const Footer = () => {
  return (
    <footer className="p-10 border-t-2 border-b-2 border-slate-100  bg-slate-50 text-slate-950 mt-8 lg:mt-32">
      <div className="footer max-w-7xl mx-auto grid gap:8 lg:gap-28 lg:grid-cols-5">
        <div className="col-span-2">
          <h3 className="text-3xl text-slate-950 font-bold">Chef World</h3>
