...
const About = () => {
	...
	return (
		<div className="max-w-7xl mx-auto mt-12 lg:mt-20 p-4 text-slate-700 text-justify">
			...
			<p className='mt-4'>So whether you're a beginner or a seasoned pro, we invite you to explore our website and discover the wonderful world of Chinese cuisine. From savory dumplings to spicy stir-fry dishes, there's something for everyone to enjoy and savor. Thank you for choosing Chinese Chef World, and happy cooking!</p>
		</div>
	);
};
